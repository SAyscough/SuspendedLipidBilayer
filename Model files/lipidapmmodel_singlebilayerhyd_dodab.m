function [output,subs_rough] = lipidapmmodel_doublebilayerhyd_dodab(params,bulk_in,bulk_out,contrast)
...
LW_thick = params(3);
%CW_thick = params(4);
bilayer_hydration_lower = params(4);
%bilayer_hydration_upper = params(6);
%bilayer_rough_lower = params(5);
%APMupperbilayer = params(8);
APMD = params(5);
monolayer_hydration = params(6);
surf_rough = params(7);
...
%TailThicku = volume_tails / APMupperbilayer;
...
Head_layer_lower = [HeadThick , Rho_heads , subs_rough , bilayer_hydration_lower , 1];
Tail_layer_lower = [TailThick , Rho_tails , subs_rough , bilayer_hydration_lower , 1];

%central_water = [CW_thick , bulk_out(contrast), subs_rough , 0 , 1];
%Head_layer_upper = [HeadThicku , Rho_heads , subs_rough , bilayer_hydration_upper , 1];
%Tail_layer_upper = [TailThicku , Rho_tails , subs_rough , bilayer_hydration_upper , 1];
...
%upper_bilayer  = [Head_layer_upper ; Tail_layer_upper ; Tail_layer_upper ; Head_layer_upper];
